...
var arrQA = [
    {
        _id: 1,
        question: '<p>現在、借金を滞納していたり<br>督促状が届いてますか？</p>',
        ...
        manga: [
            '<img src="./_resources/images/lp6/manga/v1-manga-img-1-1.jpg" alt="image">',
        ],
    },
    {
        _id: 2,
        question: '<p>差押のリスクは<br>ご存知ですか？</p>',
        ...
        manga: [
            '<img src="./_resources/images/lp6/manga/v1-manga-img-2-1.jpg" alt="image">',
        ],
    },
    {
        _id: 3,
        question: '<p>借金は返済が長引くほど<br>利息が取られ損することは<br>知ってますか？</p>',
        ...
        manga: [
            '<img src="./_resources/images/lp6/manga/v1-manga-img-3-1.jpg" alt="image">',
            '<img src="./_resources/images/lp6/manga/v1-manga-img-3-2.jpg" alt="image">',
            '<img src="./_resources/images/lp6/manga/v1-manga-img-3-3.jpg" alt="image">',
        ],
    },
    {
        _id: 4,
        question: '<p>現在、合計でどのぐらい<br>借金してますか？</p>',
    ...
    {
        _id: 5,
        question: '<p>現在、何社ぐらいから<br>借金してますか？</p>',
        label: '毎月の返済額を教えてください。',
        choices: [
            '1社',
            '2社',
    ...
    {
        _id: 6,
        question: '<p>最初に借金してから<br>どのぐらいたちましたか？</p>',
        label: '毎月の返済額を教えてください。',
        choices: [
            '0~3ヶ月未満',
            '3ヶ月~1年未満',
    ...
    {
        _id: 7,
        question: '<p>毎月の返済額を<br>教えてください。</p>',
        label: '毎月の返済額を教えてください。',
        choices: [
            '2万円以下',
            '2~5万円',
    ...
    {
        _id: 8,
        question: '<p>あなたの今の借金状態は<br>赤信号かもしれません。<br>ですが、入力いただいた<br>借入情報から督促を止めて<br>利息を0にし、借金を減額<br>できる可能性がありますが、<br>内容を知りたいですか？</p>',
        label: '毎月の返済額を教えてください。',
        choices: [
            'はい',
            'いいえ',
    ...
    setup: {
        ...
        selection: function () {
            ...
            function divRender(data) {
                ...
                var chatBotImg = 'chatbot-lp6-v1.png';

                if(data._id < 4) {
                    chatBotImg = 'chatbot-lp6-v2.png';
                }

                output += '<div id="qset-' + data._id + '" class="cf-row is-active">';
                    output += '<span class="cf-question__indicator cf-question__indicator--'+data._id+'"></span>'
                    output += '<div class="cf-question display__inline align--t">';
                        output += '<div class="cf-question__col col--1 cf-question__asst">';
                            output += '<img class="img-fit" src="_resources/images/lp6/forms/'+chatBotImg+'" alt="">';
                        output += '</div>';
                        output += '<div class="cf-question__col col--2">';
                            output += '<div class="cf-question__bubble cf-chatbubble chatbubble--asst"><span class="cf-question__number">Q'+data._id+'</span>' + data.question + '</div>';
                        output += '</div>';
                    output += '</div>';
                    output += ' <div class="cf-answer font--right">';
                        output += '<p class="cf-answer__isread">既読</p>';
                        output += '<div class="cf-answer__bubble cf-chatbubble chatbubble--you">';
                            output += '<p></p>';
                        output += '</div>';
                    output += '</div>';
                    output += '<div class="cf-manga"></div>';
                    output += '<div class="cf-choices display__inline align--t">';
            ...
            function enableAnsSelection(parentId) {
                var parent = $('#qset-' + parentId),
                    ...
                    currentId = (parseInt(parentId) - 1);
                    currentManga = arrQA[currentId]['manga'];
                ...
                btnAnswer.on('click', function (e) {
                    ...
                    // Insert Manga img
                    if(currentManga) {
                        $.each(currentManga, function (i, x) {
                            $(parent).find('.cf-manga').addClass('is-active').append(x);
                        });
                    ...
                    if(parentId == 7) {
                        setTimeout(function () {
                            $('#qset-'+nextQASetId).find('.cf-question .chatbubble--asst').append('<span class="cf-question__stop"></span>');
                        }, 1000);
                    }

                    if (nextQASetId === 9) { // show form
        ...
        existingData: function() {
            ...
            $.each(_formDetails.answers, function(i, qa) {
                ...
                var getCurrentManga = arrQA[qa.qsetId - 1]['manga'];
                var renderBox = $('.cf-box__dynamic'),
                    output = '';
                ...
                output += '<span class="cf-question__indicator cf-question__indicator--'+qa.qsetId+'"></span>'
                    output += '<div class="cf-question display__inline align--t">';
                        output += '<div class="cf-question__col col--1 cf-question__asst">';
                            output += '<img class="img-fit" src="_resources/images/lp6/forms/'+chatBotImg+'" alt="">';
                        output += '</div>';
                        output += '<div class="cf-question__col col--2">';
                            output += '<div class="cf-question__bubble cf-chatbubble chatbubble--asst">';
                            if(qa.qsetId == 8) {
                                output += '<span class="cf-question__stop"></span>';
                            }
                            output += '<span class="cf-question__number">Q'+qa.qsetId+'</span>' + getQuestion.question + '</div>';
                        output += '</div>';
                    output += '</div>';
                    output += ' <div class="cf-answer is-active font--right">';
                        output += '<p class="cf-answer__isread">既読</p>';
                        output += '<div class="cf-answer__bubble cf-chatbubble chatbubble--you">';
                    ...
                    output += '</div>';
                    if(getCurrentManga != '') {
                    output += '<div class="cf-manga is-active">';
                        // Insert Manga img
                        $.each(getCurrentManga, function (i, x) {
                            output += x;
                        });
                    output += '</div>';
                    }
        ...
        form: function () {
            ...
            form.on('submit', function (e) {
                ...
                if (formErrs === 0) {
                    if(!isRedirectToWarning) {
                        ...
                        window.location.href = baseUrl + '/warning?fr=105';
                    }
                }
            });
            ...
            function send(formData) {
                ...
                $.ajax({
                    url: baseUrl + '/mail/mail-process-lp6.php',
                    async: true,
                    cache: false,
                    type: 'post',
                    data: formData,
                    ...
                    success: function (data) {
                        ...
                        if (res.type === 'success') {
                            ...
                            window.location.href = baseUrl + '/mail/success-chatlp6.html?g=lp6&fr=105';
