...
var clp = {
    ...
    setup: {
                ...
                btnAnswer.on('click', function (e) {
                    ...
                    if (nextQASetId === 5) { // show form
                        ...
                        setTimeout(function () {
                            ...
                            clp.setup.fieldsRenderQuestion(1); // proceed with form fields animation & validation
        ...
        fieldsRenderQuestion: function(id) {
            ...
            setTimeout(function () {
                ...
                if(id === 1) { // if prefectures field
                    ...
                    clp.setup.choosePrefectures(id);
                    
                } else if(id === 2) { // if age field
                    clp.setup.chooseAge(id);

                } else if(id === 3) { // if email field
                    clp.setup.setEmail(id);

                } else if(id === 4) { // if phone field
                    clp.setup.setPhone(id);

                } else if(id === 5) {
                    clp.setup.setLastname(id);
                }
        ...
        fieldsRenderAnswer: function(id, value) {
            ...
            clp.setup.fieldsRenderQuestion(nextFieldId);
        },
        ...
        choosePrefectures: function (id) {
            ...
            function enableChooseArea(modal) {
                ...
                area.on('click', function (e) {
                    ...
                    clp.setup.fieldsRenderAnswer(id, currentVal);
                });
            }
        },
        ...
        setEmail: function(id) {
            ...
            $btn.on('click', function(e) {
                ...
                if(fieldErr === 0) {
                    clp.setup.fieldsRenderAnswer(id, $inputEmail);
                }
            });
        },
        ...
        setPhone: function(id) {
            ...
            $btn.on('click', function(e) {
                ...
                if(fieldErr === 0) {
                    clp.setup.fieldsRenderAnswer(id, phoneNum);
                }
            });
        },
        ...
        sendForm: function() {
            ...
            if(!isRedirectToWarning) {
                ...
                formData.append('form', 'チャットフォームlp');
                formData.append('admin_subject', '司法書士 渋谷法務総合事務所 | お問い合わせフォーム');
                ...
                window.location.href = baseUrl + '/warning?fr=99';
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (res.type === 'success') {
                            ...
                            window.location.href = baseUrl + '/mail/success.html?g=lp&fr=99';
