...
$inqQ5Lbl = filter_var(trim($_POST["question_5"]), FILTER_SANITIZE_STRING);
$inqQ5Ans = filter_var(trim($_POST["answer_5"]), FILTER_SANITIZE_STRING);

$inqQ6Lbl = filter_var(trim($_POST["question_6"]), FILTER_SANITIZE_STRING);
$inqQ6Ans = filter_var(trim($_POST["answer_6"]), FILTER_SANITIZE_STRING);

$inqQ7Lbl = filter_var(trim($_POST["question_7"]), FILTER_SANITIZE_STRING);
$inqQ7Ans = filter_var(trim($_POST["answer_7"]), FILTER_SANITIZE_STRING);

$inqQ8Lbl = filter_var(trim($_POST["question_8"]), FILTER_SANITIZE_STRING);
$inqQ8Ans = filter_var(trim($_POST["answer_8"]), FILTER_SANITIZE_STRING);
...
$adminMsg .= $inqQ4Lbl . ": " . $inqQ4Ans . " <br>";
$adminMsg .= $inqQ5Lbl . ": " . $inqQ5Ans . " <br>";
$adminMsg .= $inqQ6Lbl . ": " . $inqQ6Ans . " <br>";
$adminMsg .= $inqQ7Lbl . ": " . $inqQ7Ans . " <br>";
$adminMsg .= $inqQ8Lbl . ": " . $inqQ8Ans . " <br><br>";
$adminMsg .= "©".date("Y")." 渋谷法務総合事務所. All rights reserved.";
