...
$mail->Host = 'shibuya-houmu.sakura.ne.jp';
$mail->SMTPAuth = true;
$mail->Username = 'soudan@shibuya-houmu.com';
$mail->Password = 'KDTV$yVjAAvjp';
$mail->SMTPSecure = 'TLS';
$mail->Port = 587;
...
$emailReplyTo = 'soudan@shibuya-houmu.com';
...
if(!$mail->send()) {
    ...
    $msg .= "-------------------------------------<br>";
    $msg .= "【無料診断専用ダイヤル】0120-355-005　/　0120-871-244<br><br>";
    ...
    $msg .= "渋谷法務総合事務所<br>";
    $msg .= "【無料診断専用】0120-355-005　/　0120-871-244  FAX: 03-5766-8182<br>";
